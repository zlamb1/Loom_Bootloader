...
char keycode_to_ascii[128] = {
  ...
  [LOOM_KEY_T] = 't',          [LOOM_KEY_Y] = 'y',
  [LOOM_KEY_U] = 'u',          [LOOM_KEY_I] = 'i',
  [LOOM_KEY_O] = 'o',          [LOOM_KEY_P] = 'p',
  [LOOM_KEY_LEFTBRACE] = '[',  [LOOM_KEY_RIGHTBRACE] = ']',
  [LOOM_KEY_BACKSLASH] = '\\', [LOOM_KEY_A] = 'a',
  [LOOM_KEY_S] = 's',          [LOOM_KEY_D] = 'd',
  [LOOM_KEY_F] = 'f',          [LOOM_KEY_G] = 'g',
  [LOOM_KEY_H] = 'h',          [LOOM_KEY_J] = 'j',
  [LOOM_KEY_K] = 'k',          [LOOM_KEY_L] = 'l',
  [LOOM_KEY_SEMICOLON] = ';',  [LOOM_KEY_APOSTROPHE] = '\'',
  [LOOM_KEY_ENTER] = '\n',     [LOOM_KEY_Z] = 'z',
